...
```{r}
label <- "Estimated 50% emergence ratio = 1  *P* = 0.34"
...
b6 <- ggplot(brook_data, aes(x=doy, y=(emergence*100), color=trt, 
  ...
  labs(y="% waterhemp emergence", x="Day of year", 
       title = "") +
#  geom_segment(x = 180, y = 50, xend = 160, yend = 50, show.legend = FALSE,
#                  arrow = arrow(length = unit(0.5, "cm"))) +
  geom_richtext(x = 160, y = 50, show.legend = FALSE,
...
#  coord_fixed(ratio = 1, expand = TRUE, clip = on) +
  ...
  annotate("text", x= -89.06, y = 42.72, label = "Brooklyn, Dane County, WI",
           size = 2) +
  theme_test() +
  scale_x_continuous(limits=c(-93,-87)) +
